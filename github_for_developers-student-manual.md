...
Liquid error: Illegal template name '_book/16f_setting_up_remote_conflict.md'
...
Liquid error: Illegal template name '_book/14.5_git_bisect'
Liquid error: Illegal template name '_book/14.5a_what_is_git_bisect'
Liquid error: Illegal template name '_book/14.5a_use_git_bisect'
## Reverting Commits
...
Liquid error: No such template 'book/18a_understanding_reset'

Liquid error: No such template 'book/18a_reset_soft'

Liquid error: No such template 'book/18a_reset_mixed'

Liquid error: No such template 'book/18a_reset_hard'

Liquid error: No such template 'book/18a_does_gone_really_mean_gone'
